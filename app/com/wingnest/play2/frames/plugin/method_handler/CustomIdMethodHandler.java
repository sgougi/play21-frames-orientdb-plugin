...
public class CustomIdMethodHandler implements MethodHandler<CustomId> {

	@Override
	public Object processElement(final Object frame, final Method method, final Object[] arguments, final CustomId annotation, final FramedGraph<?> framedGraph, final Element element) {
	...
	public Object _processEdge(final CustomId annotation, final Method method, final Object[] arguments, final FramedGraph framedGraph, final Edge element) {
		return OrientDB.fromORIDToCustomId((ORID) element.getId());
	}
